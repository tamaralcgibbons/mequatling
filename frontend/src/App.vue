        ...
        <v-card class="mb-6">
          ...
          <v-card-text>
            <v-form @submit.prevent="createAnimal">
              ...
              <v-text-field v-model.number="form.camp_id" label="Camp ID (optional)" type="number" />
...
const headers = [
  ...
  { title: 'Upload photo', value: 'upload', sortable: false },
]
...
async function uploadPhoto(animalId) {
  ...
  await api.post(`/animals/${animalId}/upload-photo`, formData, {
